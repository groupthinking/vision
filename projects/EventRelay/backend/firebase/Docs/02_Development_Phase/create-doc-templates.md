...
### create-doc-templates(parameters)
...
**Example:**
```javascript
import { create-doc-templates } from './utils';

const result = create-doc-templates(param1, param2);
```
...
### Unit Tests
```javascript
describe('create-doc-templates', () => {
  test('should handle normal inputs', () => {
    const result = create-doc-templates('input');
    expect(result).toBe('expected');
  });

  test('should handle edge cases', () => {
    expect(() => create-doc-templates(null)).toThrow(TypeError);
  });
});
```
