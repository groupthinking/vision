					...
					{user && (
						<SidebarMenu>
							<SidebarMenuItem>
								...
								>
									<div className="h-6 w-6 flex items-center justify-center">
										{/* Simple Bar Chart Icon since lucide might not export BarChart2 directly or effectively */}
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-text-primary/60 group-hover:text-primary/80 transition-colors"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
									</div>
									{!isCollapsed && (
							...
							<SidebarMenuItem>
								...
								>
									<div className="h-6 w-6 flex items-center justify-center">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-text-primary/60 group-hover:text-primary/80 transition-colors"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>
									</div>
									{!isCollapsed && (
										<span className="text-text-primary/80 font-medium group-hover:text-primary transition-colors">
											Video Analysis
