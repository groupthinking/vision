...
/**
 * MCP code-assistant Proxy
 * Bridges npm package requests to MCP Core Server
 */

console.log('🔄 Starting @modelcontextprotocol/server-code-assistant');
...
console.log('✅ code-assistant initialized successfully');
...
const options = {
  hostname: 'localhost',
  port: 51234,
  path: '/service/code-assistant/status',
  method: 'GET'
};
