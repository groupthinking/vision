...
/**
 * MCP creative-studio Proxy
 * Bridges npm package requests to MCP Core Server
 */

console.log('🔄 Starting @modelcontextprotocol/server-creative-studio');
...
console.log('✅ creative-studio initialized successfully');
...
const options = {
  hostname: 'localhost',
  port: 51234,
  path: '/service/creative-studio/status',
  method: 'GET'
};
