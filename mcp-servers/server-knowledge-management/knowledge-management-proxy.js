...
/**
 * MCP knowledge-management Proxy
 * Bridges npm package requests to MCP Core Server
 */

console.log('🔄 Starting @modelcontextprotocol/server-knowledge-management');
...
console.log('✅ knowledge-management initialized successfully');
...
const options = {
  hostname: 'localhost',
  port: 51234,
  path: '/service/knowledge-management/status',
  method: 'GET'
};
